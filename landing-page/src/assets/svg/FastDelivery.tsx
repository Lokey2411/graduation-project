...
const FastDeliverySVG = () => {
	return (
		<svg width='inherit' height='inherit' viewBox='0 0 81 80' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
				opacity='0.3'
...
export default function FastDelivery(props: Readonly<AntdIconProps>) {
	return <Icon component={FastDeliverySVG} {...props} />;
}
