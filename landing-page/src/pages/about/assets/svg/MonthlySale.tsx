...
const SVG = () => (
	<svg width='inherit' height='inherit' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
		<path
...
export default function MonthlySaleIcon(props: Readonly<AntdIconProps>) {
